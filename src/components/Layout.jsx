    ...
    <div className="flex flex-col min-h-screen" style={{ background: 'radial-gradient(circle at 18.7% 37.8%, rgb(250, 250, 250) 0%, rgb(225, 234, 238) 90%)'}}>
      ...
      <footer className="p-4 mt-8">
        <div className="container mx-auto text-center text-gray-600">
          ...
          <Link target='_blank' to="https://github.com/midplane/forum.utils.foo/issues" className="ml-4 text-sm leading-6 text-gray-600 hover:text-gray-900">contact</Link>
        </div>
      </footer>
    </div>
  );

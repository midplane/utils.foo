      ...
      <Card>
        ...
        <CardContent>
          <textarea
            ...
            spellCheck={false}
            className="w-full h-40 resize-y font-mono text-xs bg-[var(--color-cream)] border border-[var(--color-border)] rounded-lg px-3 py-2.5 text-[var(--color-ink)] placeholder-[var(--color-ink-muted)] focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)]/20 transition-all"
          />
          {/* Status line */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full text-xs font-mono bg-[var(--color-cream)] border border-[var(--color-border)] rounded-lg px-2.5 py-1.5 text-[var(--color-ink)] focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)]/20 transition-all cursor-pointer"
                >
                  {data.columns.map((c) => (
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            active
                              ...
                              : 'border-[var(--color-border)] text-[var(--color-ink-muted)] bg-[var(--color-cream)] hover:border-[var(--color-border-dark)]'
                          )}

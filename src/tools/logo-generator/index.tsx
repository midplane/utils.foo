          ...
          <Card>
            ...
            <CardContent>
              <textarea
                ...
                className="w-full px-3 py-2 text-sm font-mono bg-[var(--color-cream)] border border-[var(--color-border)] rounded-lg text-[var(--color-ink)] placeholder-[var(--color-ink-muted)] focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)]/20 resize-none transition-all"
              />
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-8 h-8 rounded cursor-pointer border border-[var(--color-border)] p-0.5 bg-[var(--color-cream)]"
                    />
                    <Input
                      value={bgColor}
                      onChange={e => setBgColor(e.target.value)}
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        fontFamily === f.value
                          ...
                          : 'bg-[var(--color-cream)] text-[var(--color-ink)] border-[var(--color-border)] hover:border-[var(--color-ink-muted)]'
                      )}

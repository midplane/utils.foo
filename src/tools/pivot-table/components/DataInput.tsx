        ...
        <div className="flex flex-wrap gap-2">
          <label className="cursor-pointer">
            <input
              ...
              onChange={handleFile}
            />
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] text-[var(--color-ink)] hover:border-[var(--color-ink-muted)] transition-all cursor-pointer">
